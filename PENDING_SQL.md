...
| 11 | `supabase/migrations/add_avatar_storage.sql` | Supabase Storage avatars bucket + RLS | ? Applied (2026-05-23) |ù fixes read-modify-write race in `adjustLikesCount` | ? Applied via browser agent (2026-05-23) |
